...
def render_contrastive_feature(viewpoint_camera, pc: FeatureGaussianModel, pipe, bg_color: torch.Tensor,
                               scaling_modifier=1.0, nonlinear=None, override_color=None, filter_by_prob=-1,
                               dropout=-1):
    """
    Render the scene. 
