...
DATASET.add_argument('--RGBD_3D_ROOT', type=str, default='/data/SYJ/Datasets/3dmatch_rgbd')  # need rewrite
DATASET.add_argument('--SCANNET_ROOT', type=str, default='/media/zju231/Elements/scannet/ScanNetRGBD')
...
DATASET.add_argument('--num_workers', type=int, default=1)
...
MODEL.add_argument('--model', type=str, default='3DGS', choices=['PCReg_KPURes18_MSF', '3DGS', 'SAM'])
...
ALIGN.add_argument('--num_correspodances', type=int, default=256)
ALIGN.add_argument('--point_ratio', type=int, default=0.3)
...
SYSTEM.add_argument('--NUM_WORKERS', type=int, default=2)
...
EXPERIMENT.add_argument('--checkpoint', type=str,
                        default="./logs/experiments/resumed_URRScanNet_0415-1349/checkpoint@e0000s0060000.pkl")
EXPERIMENT.add_argument('--EXPname', type=str, default="URRScanNet")
...
REPO_PATH = '/data/SYJ/Pycharmprojects/PointMBF-main (3DGS)'
